...
const SidebarTriggerCircle = React.forwardRef(
  ({ className, onClick, ...props }, ref) => {
    const { toggleSidebar, state } = useSidebar(); // adjust based on your hook
    const isCollapsed = state === "expanded"; // update if your hook uses another key
...
SidebarTriggerCircle.displayName = "SidebarTriggerCircle";

// export default SidebarTriggerCircle;
