      ...
      >
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center">Expense Total</TableHead>
        ...
        <TableBody>
          {data.payments.map((p, idx) => (
            <TableRow key={idx}>
              ...
              <TableCell className="text-center">{p.billNo || "NA"}</TableCell>
              <TableCell className="text-center">{data.farmerName}</TableCell>
              ...
              <TableCell className="text-right">{formatCurrency(p.expenseTotal || 0)}</TableCell>
          ...
          <TableRow className="font-semibold bg-muted">
            ...
            <TableCell className="text-right">{formatCurrency(data.totalPaid || 0)}</TableCell>
          </TableRow>
          <TableRow className="font-semibold bg-muted">
            <TableCell colSpan={10}></TableCell>
            <TableCell className="text-right">Balance</TableCell>
